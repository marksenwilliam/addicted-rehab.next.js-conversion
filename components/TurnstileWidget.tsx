...
export default function TurnstileWidget({
    ...
    return (
        <div className="flex flex-col items-center gap-2 my-4">
            {status === "loading" && (
                <div className="flex items-center gap-2 py-3 text-sm text-brand-cream/70">
            ...
            {status === "error" && (
                <div className="text-sm text-amber-400 py-2">
                    ⚠️ Verifieringen kunde inte laddas. Du kan fortfarande skicka formuläret.
                </div>
            )}

            {status === "timeout" && (
                <div className="text-sm text-amber-400 py-2">
                    ⏱️ Verifieringen tog för lång tid. Du kan fortsätta ändå.
                </div>
            )}

            {status === "verified" && (
                <div className="text-sm text-green-400 py-2 flex items-center gap-1">
