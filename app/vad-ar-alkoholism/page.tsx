...
export default function VadArAlkoholismPage() {
    return (
        <>
            ...
            <section className="grid grid-cols-1 lg:grid-cols-2 min-h-screen bg-brand-white">
                <div className="flex flex-col justify-center px-8 py-16 lg:px-20 lg:py-24 order-2 lg:order-1">
                    <div className="max-w-xl mx-auto lg:mx-0 space-y-8">
                        <h2 className="font-serif text-5xl md:text-6xl font-medium text-brand-navy leading-tight tracking-tight">
                            Vad är <br />
                            <span className="text-brand-navy/80">alkoholism</span>
                        </h2>
                        ...
                        <div className="pt-8 space-y-6">
                            <h3 className="font-serif text-4xl md:text-5xl font-medium text-brand-navy leading-tight">
            ...
            <section className="grid grid-cols-1 lg:grid-cols-2 min-h-screen bg-brand-cream/50">
                <div className="relative h-96 lg:h-auto overflow-hidden bg-brand-cream">
                    <Image
                        src="/images/senaste%20bilden.jpg"
                ...
                <div className="flex flex-col justify-center px-8 py-16 lg:px-20 lg:py-24">
                    <div className="max-w-xl mx-auto lg:mx-0 space-y-12">
                        ...
                        <div className="space-y-6">
                            <h2 className="font-serif text-4xl md:text-5xl font-medium text-brand-navy leading-tight">
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-24">
                        <article className="space-y-6 border-l-2 border-brand-navy pl-8">
                            <h3 className="font-serif text-2xl md:text-3xl font-medium text-brand-navy">
