...
export default function OmOssPage() {
    return (
        <>
            ...
            <section className="py-24 bg-brand-white">
                <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    ...
                    <AnimateOnScroll animation="fadeLeft" delay={0.1}>
                        <div>
                            <h2 className="font-serif text-4xl md:text-5xl text-brand-header-text mb-2">Arne Stålberg</h2>
            ...
            {/* Team Section - Jan */}
            <section className="py-24 bg-brand-section-bg border-y-2 border-brand-navy/5">
                <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    {/* Text Left */}
                    <AnimateOnScroll animation="fadeRight" className="order-2 md:order-1">
                        <div>
                            <h2 className="font-serif text-4xl md:text-5xl text-brand-header-text mb-2">Jan Hellberg</h2>
                            <p className="text-brand-orange tracking-widest text-sm font-bold uppercase mb-8">
                    ...
                    {/* Image Right */}
                    <AnimateOnScroll animation="fadeLeft" delay={0.1} className="order-1 md:order-2">
                        <div className="relative group">
                            <div className="absolute inset-0 border-2 border-brand-orange sketchy-box transform rotate-2 scale-105 opacity-20"></div>
                            <div className="relative sketchy-box overflow-hidden border-2 border-brand-navy shadow-sketch transform -rotate-1 transition-transform group-hover:rotate-0">
                                <Image
            ...
            <section className="py-24 bg-brand-white relative overflow-hidden">
                <div className="container mx-auto px-6 max-w-3xl relative z-10">
                    <AnimateOnScroll animation="fadeUp" className="text-center mb-16">
                        ...
                        <h2 className="font-serif text-5xl md:text-6xl text-brand-header-text">Arnes Story</h2>
                    </AnimateOnScroll>
                    ...
                    <div className="space-y-16 text-brand-gray font-sans text-lg leading-relaxed">
                        ...
                        <AnimateOnScroll animation="fadeUp">
                            <div>
                                <div className="flex items-center gap-4 mb-6">
                                    <div className="w-12 h-12 rounded-full bg-brand-navy flex items-center justify-center text-brand-orange font-bold text-xl hover-scale cursor-default">
                                        1
                                    </div>
                        ...
                        <AnimateOnScroll animation="scale">
                            <div className="bg-brand-navy text-brand-cream p-12 rounded-2xl text-center my-16 hover-glow">
            ...
            {/* Contact CTA */}
            <section id="contact" className="py-16 bg-brand-section-bg border-t border-brand-navy/10">
                <AnimateOnScroll animation="fadeUp">
